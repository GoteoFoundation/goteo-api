...
MySQL - 5.7.20-0ubuntu0.16.04.1 : Database - goteodev
*********************************************************************
*/
...
DROP TABLE `banner`;
DROP TABLE `banner_lang`;
DROP TABLE `bazar_lang`;
DROP TABLE `blog`;
DROP TABLE `call`;
DROP TABLE `call_banner`;
DROP TABLE `call_banner_lang`;
DROP TABLE `call_category`;
DROP TABLE `call_conf`;
DROP TABLE `call_icon`;
DROP TABLE `call_lang`;
DROP TABLE `call_location`;
DROP TABLE `call_post`;
DROP TABLE `call_project`;
DROP TABLE `call_sphere`;
DROP TABLE `call_sponsor`;
DROP TABLE `campaign`;
DROP TABLE `category`;
...
DROP TABLE `cost`;
DROP TABLE `cost_lang`;
DROP TABLE `criteria`;
DROP TABLE `criteria_lang`;
DROP TABLE `document`;
DROP TABLE `event`;
DROP TABLE `faq`;
DROP TABLE `faq_lang`;
DROP TABLE `feed`;
DROP TABLE `glossary`;
DROP TABLE `glossary_image`;
DROP TABLE `glossary_lang`;
DROP TABLE `home`;
DROP TABLE `icon`;
DROP TABLE `icon_lang`;
DROP TABLE `icon_license`;
DROP TABLE `image`;
DROP TABLE `info`;
DROP TABLE `info_image`;
DROP TABLE `info_lang`;
DROP TABLE `invest`;
DROP TABLE `invest_address`;
DROP TABLE `invest_detail`;
DROP TABLE `invest_location`;
DROP TABLE `invest_msg`;
DROP TABLE `invest_node`;
DROP TABLE `invest_reward`;
DROP TABLE `license`;
DROP TABLE `license_lang`;
DROP TABLE `log`;
DROP TABLE `mail`;
DROP TABLE `mail_stats`;
DROP TABLE `mail_stats_location`;
DROP TABLE `mailer_content`;
DROP TABLE `mailer_control`;
DROP TABLE `mailer_limit`;
DROP TABLE `mailer_send`;
DROP TABLE `matcher`;
DROP TABLE `matcher_lang`;
DROP TABLE `matcher_project`;
DROP TABLE `matcher_user`;
DROP TABLE `message`;
DROP TABLE `message_lang`;
DROP TABLE `message_user`;
DROP TABLE `metric`;
DROP TABLE `milestone`;
DROP TABLE `milestone_lang`;
DROP TABLE `news`;
DROP TABLE `news_lang`;
DROP TABLE `node`;
DROP TABLE `node_data`;
DROP TABLE `node_lang`;
DROP TABLE `open_tag`;
DROP TABLE `open_tag_lang`;
DROP TABLE `origin`;
DROP TABLE `page`;
DROP TABLE `page_lang`;
DROP TABLE `page_node`;
DROP TABLE `post`;
DROP TABLE `post_image`;
DROP TABLE `post_lang`;
...
DROP TABLE `project_lang`;
DROP TABLE `project_location`;
DROP TABLE `project_milestone`;
DROP TABLE `project_open_tag`;
DROP TABLE `promote`;
DROP TABLE `promote_lang`;
DROP TABLE `purpose`;
DROP TABLE `purpose_copy`;
DROP TABLE `relief`;
DROP TABLE `review`;
DROP TABLE `review_comment`;
DROP TABLE `review_score`;
DROP TABLE `reward`;
DROP TABLE `reward_lang`;
DROP TABLE `role`;
DROP TABLE `social_commitment`;
DROP TABLE `social_commitment_lang`;
DROP TABLE `sphere`;
DROP TABLE `sphere_lang`;
DROP TABLE `sponsor`;
DROP TABLE `stories`;
DROP TABLE `stories_lang`;
DROP TABLE `support`;
DROP TABLE `support_lang`;
DROP TABLE `tag`;
DROP TABLE `tag_lang`;
DROP TABLE `task`;
DROP TABLE `template`;
DROP TABLE `template_lang`;
DROP TABLE `text`;
DROP TABLE `user`;
DROP TABLE `user_api`;
DROP TABLE `user_call`;
DROP TABLE `user_donation`;
DROP TABLE `user_favourite_project`;
...
DROP TABLE `user_translang`;
DROP TABLE `user_translate`;
DROP TABLE `user_vip`;
DROP TABLE `user_web`;
DROP TABLE `worthcracy`;
DROP TABLE `worthcracy_lang`;
...
CREATE TABLE `blog` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Blogs de nodo o proyecto';
