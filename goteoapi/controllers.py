...
__import__('goteoapi.social_commitments.controllers')
__import__('goteoapi.sdgs.controllers')
__import__('goteoapi.footprints.controllers')
__import__('goteoapi.licenses.controllers')
__import__('goteoapi.calls.controllers')
__import__('goteoapi.matchers.controllers')
